      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-full absolute flex flex-col items-center px-6" style={{ top: '2em', display: 'flex', gridArea: 'auto' }}>
                <GradientText
                  colors={["#00f2fe", "#4facfe", "#00f2fe"]}
                  animationSpeed={3}
                  showBorder={false}
                  className="font-black tracking-tighter m-0"
                >
                  <span style={{ fontSize: 'min(4svh, 1.8em)', display: 'block', lineHeight: '1.1' }}>{name}</span>
                </GradientText>
                
                <div className="mt-2">
                  <GradientText
                    colors={["#f9d423", "#ff4e50", "#f9d423"]}
                    animationSpeed={5}
                    showBorder={false}
                    className="font-bold whitespace-nowrap italic"
                  >
